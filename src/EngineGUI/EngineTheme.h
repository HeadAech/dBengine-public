...
#include "imgui_impl/imgui_spectrum.h"
#include <vector>

using namespace ImGui;

/// <summary>
/// Class responsible for managing the themes of the engine's editor.
/// </summary>
class EngineTheme {
public:

    /// <summary>
    /// All available themes for the engine's editor.
    /// </summary>
    std::vector<std::string> themes = {"Glass", "Modern Colors", "Material You",  "Catpuccino Mocha",
                                       "Dark",  "Bess Dark",     "Dark FluentUI", "Light FluentUI",
                                       "Hazel", "Unreal"};

    /// <summary>
    /// Sets the theme based on the index provided.
    /// </summary>
    /// <param name="i">Index of theme</param>
    void SetTheme(int i) {
        ...
        switch (i) {
            case 0:
                ...
                break;
            case 1:
                SetModernColorsTheme();
                break;
            case 2:
                SetMaterialYouTheme();
                break;
            case 3:
                SetCatpuccinoMochaTheme();
                break;
            case 4:
                SetDarkTheme();
                break;
            case 5:
                ...
                break;
            case 6:
                SetDarkFluentUITheme();
                break;
            case 7:
                SetLightFluentUITheme();
                break;
            case 8:
                SetHazelTheme();
                break;
    ...
    void SetHazelTheme()
    {
        ...
        // Obrysy
        colors[ImGuiCol_Border] = ImVec4(0.35f, 0.35f, 0.39f, 0.60f);
        colors[ImGuiCol_BorderShadow] = ImVec4(0.00f, 0.00f, 0.00f, 0.00f);
        ...
        colors[ImGuiCol_ButtonHovered] = ImVec4(0.35f, 0.38f, 0.43f, 1.00f);
        colors[ImGuiCol_ButtonActive] = ImVec4(0.25f, 0.28f, 0.33f, 1.00f);

        // Suwaki
        colors[ImGuiCol_SliderGrab] = ImVec4(0.80f, 0.70f, 0.30f, 0.80f); // 鄴速awy akcent
        colors[ImGuiCol_SliderGrabActive] = ImVec4(0.90f, 0.75f, 0.30f, 1.00f);
        ...
        colors[ImGuiCol_TabActive] = ImVec4(0.20f, 0.20f, 0.23f, 1.00f);
    ...
    void SetUnrealTheme()
    {
        ...
        // G堯wne kolory - ciemny motyw UE
        colors[ImGuiCol_Text] = ImVec4(0.86f, 0.86f, 0.86f, 1.00f);
        colors[ImGuiCol_TextDisabled] = ImVec4(0.44f, 0.44f, 0.44f, 1.00f);
        colors[ImGuiCol_WindowBg] = ImVec4(0.11f, 0.11f, 0.11f, 1.00f); // T這 okna
        colors[ImGuiCol_ChildBg] = ImVec4(0.15f, 0.15f, 0.15f, 1.00f);
        colors[ImGuiCol_PopupBg] = ImVec4(0.12f, 0.12f, 0.12f, 0.95f);
        colors[ImGuiCol_Border] = ImVec4(0.24f, 0.24f, 0.24f, 0.60f);
        colors[ImGuiCol_BorderShadow] = ImVec4(0.00f, 0.00f, 0.00f, 0.00f);
        colors[ImGuiCol_FrameBg] = ImVec4(0.20f, 0.20f, 0.20f, 1.00f);
        ...
        colors[ImGuiCol_CheckMark] = ImVec4(0.33f, 0.67f, 1.00f, 1.00f); // niebieski UE
        colors[ImGuiCol_SliderGrab] = ImVec4(0.33f, 0.67f, 1.00f, 1.00f);
        colors[ImGuiCol_SliderGrabActive] = ImVec4(0.47f, 0.75f, 1.00f, 1.00f);
        colors[ImGuiCol_Button] = ImVec4(0.20f, 0.20f, 0.20f, 1.00f);
        colors[ImGuiCol_ButtonHovered] = ImVec4(0.33f, 0.67f, 1.00f, 1.00f);
        colors[ImGuiCol_ButtonActive] = ImVec4(0.15f, 0.45f, 0.80f, 1.00f);
        colors[ImGuiCol_Header] = ImVec4(0.20f, 0.25f, 0.35f, 1.00f);
        colors[ImGuiCol_HeaderHovered] = ImVec4(0.33f, 0.67f, 1.00f, 0.80f);
        colors[ImGuiCol_HeaderActive] = ImVec4(0.20f, 0.25f, 0.35f, 1.00f);
        colors[ImGuiCol_Separator] = ImVec4(0.28f, 0.28f, 0.28f, 1.00f);
        colors[ImGuiCol_ResizeGrip] = ImVec4(0.33f, 0.67f, 1.00f, 0.25f);
        colors[ImGuiCol_ResizeGripHovered] = ImVec4(0.33f, 0.67f, 1.00f, 0.67f);
        colors[ImGuiCol_ResizeGripActive] = ImVec4(0.33f, 0.67f, 1.00f, 0.95f);
        colors[ImGuiCol_Tab] = ImVec4(0.14f, 0.14f, 0.14f, 1.00f);
        colors[ImGuiCol_TabHovered] = ImVec4(0.33f, 0.67f, 1.00f, 0.80f);
        colors[ImGuiCol_TabActive] = ImVec4(0.20f, 0.25f, 0.35f, 1.00f);
        colors[ImGuiCol_TabUnfocused] = ImVec4(0.10f, 0.10f, 0.10f, 1.00f);
        colors[ImGuiCol_TabUnfocusedActive] = ImVec4(0.15f, 0.18f, 0.25f, 1.00f);
        colors[ImGuiCol_DockingPreview] = ImVec4(0.33f, 0.67f, 1.00f, 0.70f);
        colors[ImGuiCol_NavHighlight] = ImVec4(0.33f, 0.67f, 1.00f, 1.00f);

        // Styl padding闚 i rounding
        style.FrameRounding = 4.0f;
        style.GrabRounding = 4.0f;
        style.WindowRounding = 5.0f;
