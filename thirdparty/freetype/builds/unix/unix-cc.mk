...
#
CPPFLAGS := 
CFLAGS   := -c -Wall -g -O2 -fvisibility=hidden -DDARWIN_NO_CARBON   -I/opt/homebrew/opt/libpng/include/libpng16 -pthread \
...
# Linker flags.
#
LDFLAGS :=  -lz -lbz2 -L/opt/homebrew/opt/libpng/lib -lpng16 -pthread -lpthread
